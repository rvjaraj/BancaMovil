...
a persistence unit "BancaMovilPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BancaMovil\pom.xml":
...
artifact ("BancaMovil.war") is already built. You can build
