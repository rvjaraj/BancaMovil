...
CREATE TABLE IF NOT EXISTS `sistemabancario`.`Solicitud` (
  ...
  `proposito` VARCHAR(500) NOT NULL,
  `cantidad` DOUBLE NOT NULL,
  `saldocuenta` VARCHAR(45) NULL,
  `tiempoempleo` DOUBLE NULL,
  `tasadepagos` DOUBLE NULL,
  `estadocivil` VARCHAR(45) NULL,
  `garante` VARCHAR(45) NULL,
  `avaluovivienda` DOUBLE NULL,
  `trebajadorextrangero` TINYINT NULL,
  `edad` INT NULL,
