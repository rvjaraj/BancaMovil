...
public class SolicitudSRV {
    ...
    private String estadocivilysexo;
    ...
    public String getEstadocivilysexo() {
        return estadocivilysexo;
    }

    public void setEstadocivilysexo(String estadocivilysexo) {
        this.estadocivilysexo = estadocivilysexo;
    }
